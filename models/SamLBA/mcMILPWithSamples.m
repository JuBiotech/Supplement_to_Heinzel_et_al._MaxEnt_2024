function [ nAltSols, altSols ] = mcMILPWithSamples( model, samples,  groups, nWorkers )
...
%   Detailed explanation goes here
    ...
    altSols = cell(size(samples, 2),1);
    nAltSols = zeros(size(samples, 2), 1);
    ...
    parfor i = 1:size(samples,2)
        ...
        altSols{i} = altOptEnumerator(modelMod, false);
        nAltSols(i) = size(altSols{i}, 2);
    end
